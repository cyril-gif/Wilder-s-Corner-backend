...
export const orderValidation = [
  body('orderItems').isArray({ min: 1 }).withMessage('At least one item required'),
  ...
  body('shippingAddress.addressLine1').notEmpty().withMessage('Address line required'),
  ...
  body('paymentMethod').isIn(['cash_on_delivery', 'card', 'paystack']).withMessage('Invalid payment method'),
